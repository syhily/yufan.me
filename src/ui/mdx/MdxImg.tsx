...
import { useImageMeta } from '@/ui/mdx/image-meta-context'

// `<img>` override for MDX bodies. This component wires the thumbhash
// placeholder into the tree and lazily resolves missing hashes through a
// small GET endpoint, cached by image `src`.
export type MdxImgProps = Omit<ImgHTMLAttributes<HTMLImageElement>, 'ref'> & {
