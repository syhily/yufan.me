...
import { FootnoteProvider, FootnotePreviewRegistrar, FootnoteReference } from '@/ui/pt/Footnotes'
...
// `@/ui/pt/blocks/*` component so the renderer composes the same
// React tree across pages and posts.
//
