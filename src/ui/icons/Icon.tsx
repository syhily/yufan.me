...
// "Pass icons as objects, not string keys" rule). The runtime dispatcher
// (`iconByName` + `<DynamicIcon>`) lives in `@/ui/icons/runtime`; it covers
// the small number of call sites that select an icon from runtime
// configuration (social links, share buttons, QR dialogs).
...
// `@/ui/icons/icons` is asserted by `iconByName` in `@/ui/icons/runtime`.
