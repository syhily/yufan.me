// Per-icon React components, one named export per icon. Path data is
// inlined as JSX so the bundler can statically tree-shake unused icons
// (`bundle-analyzable-paths`) and there is no runtime SVG parsing or
