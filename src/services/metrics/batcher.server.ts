import { incrementPageViewsBatch } from '@/db/query/page.server'
...
//
// Note: in dev the Astro middleware/handlers can be re-evaluated on every
// request which would create multiple batchers — we guard by attaching the
// instance to globalThis to keep one per process.
