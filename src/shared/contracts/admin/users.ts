...
export const adminUsersContract = c.router(
  {
    list: {
      ...
      responses: {
        200: z.object({ users: z.array(adminUserDto), total: z.coerce.number(), hasMore: z.boolean() }),
        ...standardReadErrors,
      },
      summary: '管理后台：用户列表',
    },
    ...
    bulkApproveComments: {
      ...
      body: userIdBody,
      responses: { 200: z.object({ approved: z.coerce.number() }), ...standardMutationErrors },
    ...
    bulkDeleteComments: {
      ...
      body: userIdBody,
      responses: { 200: z.object({ deleted: z.coerce.number() }), ...standardMutationErrors },
