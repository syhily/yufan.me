...
export function makeNewCommentEmailTemplate(data: {
  ...
  const tmp = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
<![endif]-->
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="font-size: 24px; font-family: &quot;arial black&quot;, helvetica, sans-serif">${config.title}</span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:4px 0px 4px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="font-size: 10px">Thanks for registering </span><a href="${import.meta.env.SITE}"><span style="font-size: 10px">${config.title}</span></a><span style="font-size: 10px">.</span></div><div></div></div></td>
      </tr>
    </tbody>
...
<div style="font-family: inherit; text-align: inherit"><a href="{{notification_preferences_link}}"><span style="font-size: 10px">Notification preferences</span></a></div><div></div></div></td>
    ...
    <tbody>
      ...
      <a role="social-icon-link" href="https://x.com/${config.settings.twitter}" target="_blank" alt="Twitter" title="Twitter" style="display:inline-block; background-color:#7AC4F7; height:21px; width:21px;">
