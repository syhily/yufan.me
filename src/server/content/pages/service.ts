...
import {
  ...
  type CmsPage,
} from '@/server/content/pages/projection'
import {
  countPageMetas,
  findContentById,
  findContentsByIds,
...
} from '@/server/content/pages/repository'
import { commentCountsByOwnerIds, metricsByOwnerIds } from '@/server/infra/db/query/like'
import { ensureMetric } from '@/server/infra/db/query/metric'
...
export type { AdminPageDetailDto, AdminPageDto, AdminRevisionDto, CmsPage } from '@/server/content/pages/projection'
