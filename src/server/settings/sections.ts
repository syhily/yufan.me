...
import { SETTINGS_SECTIONS, type SettingsSection, type UpdateSettingsInput } from '@/shared/settings'
...
// Exported so `@/server/rate-limit` can use the same constants for its
