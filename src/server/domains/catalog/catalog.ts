...
import { buildCatalogSnapshot } from '@/server/domains/catalog/build'
import { getCatalogVersion, subscribeCatalogInvalidate } from '@/server/domains/catalog/invalidate'
...
//   @/server/domains/catalog/queries        category / tag / friend lookups
//   @/server/domains/catalog/invalidate     invalidateCatalog, subscribe…
//   @/server/domains/catalog/snapshot       CatalogSnapshot, CatalogEntry types
