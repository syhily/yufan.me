...
import type { Category, Friend, Tag } from '@/shared/types/catalog'

import { buildDbPage, findPageBySlug, listAllPages } from '@/server/content/pages/query'
import {
  buildPermalinkSet,
  findPostBySlug,
...
import { findCategoryByName, findCategoryBySlug } from '@/server/infra/db/query/category'
import { findTagByName, findTagBySlug } from '@/server/infra/db/query/tag'
import { category as categoryTable, post as postMetaTable, tag as tagTable } from '@/server/infra/db/schema'
