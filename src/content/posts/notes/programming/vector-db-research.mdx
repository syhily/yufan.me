...
cover: https://cat.yufan.me/images/2025/01/2025011601423200.jpg
published: true
---

![](https://cat.yufan.me/images/2025/01/2025011601423200.jpg)
...
![](https://cat.yufan.me/images/recaps/vector-db-research/elasticsearch-nodes.png)
...
![](https://cat.yufan.me/images/recaps/vector-db-research/multiple-milvus-architecture.png)
...
![](https://cat.yufan.me/images/recaps/vector-db-research/different-milvus-clusters.png)

#### Milvus Distributed Architecture

![](https://cat.yufan.me/images/recaps/vector-db-research/milvus-distributed-architecture.png)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        As the increase of the number of Elasticsearch cluster. We may need more replicas to balance
        the query for avoiding hot zone.
      </td>
      <td>
        Etcd requires high performance disk for better serving metadata. It could be a bottleneck
        when the query increases.
        <br />
        Files on object storage need to be pulled to the local disk and eventually loaded into
        memory for querying. If this process switches frequently, the performance may not
        necessarily be good.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>Storage</td>
      <td>
        Every data node&#39;s hard disk. Require to add new data node to increase the storage. S3 is
        only used as the backup storage.
      </td>
...
![](https://cat.yufan.me/images/recaps/vector-db-research/index-flow-in-elasticsearch.png)
...
![](https://cat.yufan.me/images/recaps/vector-db-research/elasticsearch-index-request-flow.png)

This diagram shows the whole routine for a simple index request.

#### Data Writing Flow in Milvus

![](https://cat.yufan.me/images/recaps/vector-db-research/data-writing-flow-in-milvus.png)
...
![](https://cat.yufan.me/images/recaps/vector-db-research/milvus-data-writing-overview.png)

### Data model in Vector

#### Data Model Elasticsearch

![](https://cat.yufan.me/images/recaps/vector-db-research/data-model-elasticsearch.png)
...
![](https://cat.yufan.me/images/recaps/vector-db-research/data-model-in-milvus.png)
...
![](https://cat.yufan.me/images/recaps/vector-db-research/milvus-shard.png)
...
![](https://cat.yufan.me/images/recaps/vector-db-research/milvus-segments.png)
...
![](https://cat.yufan.me/images/recaps/vector-db-research/query-flow-in-elasticsearch.png)
...
![](https://cat.yufan.me/images/recaps/vector-db-research/fetch-flow-in-elasticsearch.png)
...
![](https://cat.yufan.me/images/recaps/vector-db-research/elasticsearch-knn-flow.jpg)

#### Query Flow in Milvus

![](https://cat.yufan.me/images/recaps/vector-db-research/query-flow-in-milvus.png)
...
![](https://cat.yufan.me/images/recaps/vector-db-research/tf-idf-explain.png)
...
![](https://cat.yufan.me/images/recaps/vector-db-research/sparse-bm25-in-milvus.png)
