...
tags:
  ...
  - 演讲
category: 编程
cover: https://stage-asset.yufan.me/images/2019/05/2019050913525690.jpg
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/01.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/02.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/03.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/04.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/05.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/06.jpg)

现在，问题来了，刚才那个项目那么简单，那个，整个项目的启动过程中，到底发生了哪些魔法呢？

![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/07.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/08.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/09.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/10.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/11.jpg)

上面是我从 Spring Boot 1.3.6 中找到的 spring.factories 文件的截图。当然，基本上只要上面有的，都能得到不错的支持。

![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/12.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/13.jpg)

当然 Starter 也是一把双刃剑，比如我在项目里面依赖了 `spring-boot-starter-data-jpa` 之后在 IDEA 里面看到的依赖树，简直就是 jar 包狂魔，虽然我们需要 jpa，但是不一定需要全部这些包。

![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/14.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/15.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/16.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/17.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/18.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/19.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/20.jpg)

然而一个项目，基本上包含 `SpringApplication` 和 main 方法的类只有一个，所以在1.4 之后，我们连 App.class 都不需要给定，直接使用 `@SpringBootTest` 注解即可，更加优雅。

![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/21.jpg)

这个就是我基于 Spring Boot 1.3 写的一个集成测试，当然它使用的是我们前面说的方法3。

![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/22.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/23.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/24.jpg)

这个是添加默认 Profile 的方式，原来我是尝试在 application 配置文件里面设置，但是不生效，最后我只好手动编码实现。

![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/25.jpg)

这个方法是和 main 方法同级的一个方法，需要 Autowired Spring 的 Environment 接口，然后获取 Profile 的配置，即可自行实现判断逻辑。（期待后面 Profile 能更加完善，实现 Block 一类的属性）

![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/26.jpg)

![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/27.jpg)

![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/28.jpg)

![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/29.jpg)
...
![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/30.jpg)

如果想要快速创建一个 Spring Boot 项目开发，有且不仅有上述几种方式。

![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/31.jpg)

![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/32.jpg)

![](https://stage-asset.yufan.me/images/slide/spring-boot-intro/33.jpg)

你可以点击 [这里](https://stage-asset.yufan.me/uploads/springboot-intro.pdf) 下载到本地浏览。
