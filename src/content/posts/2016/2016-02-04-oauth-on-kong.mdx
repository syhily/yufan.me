...
category: 编程
toc: true
cover: https://stage-asset.yufan.me/images/2020/09/2020090420223787.jpg
summary: 一个完整的 OAuth 2.0 认证需要好几步，然而，Kong只完成最后几步，实际使用时需要开发上层的服务。
published: true
---

![もりちか - フレンドリーな猫に出会って、写真を撮りたくなっている女の子](https://stage-asset.yufan.me/images/2020/09/2020090420290983.jpg)
