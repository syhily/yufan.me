CREATE TYPE "user_role" AS ENUM('admin', 'author', 'visitor');--> statement-breakpoint
...
CREATE INDEX "idx_page_slug" ON "page" ("slug");--> statement-breakpoint
...
CREATE INDEX "idx_post_search_embedding" ON "post_search_index" USING hnsw ("embedding" vector_cosine_ops);--> statement-breakpoint
CREATE INDEX "idx_tag_slug" ON "tag" ("slug");--> statement-breakpoint
