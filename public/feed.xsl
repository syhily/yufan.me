  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body>
        ...
        <div class="footer">
          <a class="title" href="https://yufan.me/?utm_medium=feed">且听书吟</a>
          <nav>
            <a href="https://yufan.me/about?utm_medium=feed">关于</a>
            <a href="https://yufan.me/links?utm_medium=feed">友链</a>
          </nav>
        </div>
      </body>
    </html>
