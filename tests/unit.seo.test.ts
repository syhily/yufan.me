...
const fixture: BlogSettingsBundle = {
  ...
  comments: { comments: { size: 10, avatar: { mirror: 'https://cdn.test.example/avatar', size: 80 } } },
  seo: {
    twitter: '@tester',
  ...
  cache: {
    cache: {
      ...
      'image-meta': { prefix: 'image-meta:', ttlSeconds: 3600 },
      'comments-md': { prefix: 'comments-md:', ttlSeconds: 3600 },
    },
  },
  rateLimit: {
